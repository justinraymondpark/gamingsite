        ...
        <div className="w-full max-w-md">
          <div className="bg-[var(--surface)] rounded-lg p-8 border border-[var(--border)]">
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-white text-gray-800 rounded-lg font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center gap-3 border border-gray-300"
            >
        ...
        <div className="w-full max-w-md">
          <div className="bg-[var(--surface)] rounded-lg p-8 border border-[var(--border)]">
            ...
            <p className="text-[var(--foreground-muted)] mb-4">
              Sorry, <span className="text-[var(--foreground)]">{user.email}</span> is not authorized to access the admin panel.
            </p>
            <button
